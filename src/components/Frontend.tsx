    ...
    >
      <div className="w-[300px] mx-auto py-2 px-2">
        ...
        <div className="flex items-center justify-center">
          <button
            className="w-44 h-10 flex items-center justify-center rounded-lg bg-red-700 hover:bg-red-600 text-white my-2 mx-1"
            onClick={() => {
          ...
          <button className="w-44 h-10 flex items-center justify-center rounded-lg bg-red-700 hover:bg-red-600 text-white my-2 mx-1">
            Report Sybil
          </button>
        </div>

        <button className="w-full h-10 flex items-center justify-center rounded-lg bg-red-700 hover:bg-red-600">
          Add frame to client
        </button>
        ...
        <div>
          {JSON.stringify(
            {
              // requestAttestationData,
              RequestAttestationError,
              isRequestAttestationError,
              isRequestAttestationPending,
            },
            null,
            2
          )}
